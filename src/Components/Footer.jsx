...
const Footer = () => {
  return (
    <>
      <footer className="bg-white bg-opacity-30 rounded-lg dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-4 text-base font-semibold text-black uppercase dark:text-white">
                  Menu
                </h2>
                <ul className="text-black dark:text-gray-400 font-medium">
                  ...
                  <li className="mb-2">
                    <a className="hover:underline">Staking</a>
                  </li>
                  <li className="mb-2">
                    <a className="hover:underline">Reward</a>
                  </li>
                </ul>
              </div>
              <div>
